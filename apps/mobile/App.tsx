...
export default function App() {
  ...
  return <SafeAreaView style={styles.safe}><StatusBar style="dark" /><ScrollView style={styles.scrollArea} contentContainerStyle={styles.content}>
    ...
    {screen === "log" ? <LogScreen foodForm={foodForm} setFoodForm={setFoodForm} scannedFood={scannedFood} addFood={addFood} editingFoodId={editingFoodId} cancelFoodEdit={cancelFoodEdit} query={query} setQuery={setQuery} foodOptions={foodOptions} searching={searching} foodSearchDone={foodSearchDone} foodSearchError={foodSearchError} doSearch={doSearch} applyApiFood={applyApiFood} recentFoods={recentFoods} favoriteFoods={favoriteFoods} applyFoodTemplate={applyFoodTemplate} toggleFavoriteFood={toggleFavoriteFood} savedMeals={savedMeals} savedMealName={savedMealName} setSavedMealName={setSavedMealName} savedMealBase={savedMealBase} setSavedMealBase={setSavedMealBase} createSavedMealFromDay={createSavedMealFromDay} applySavedMeal={applySavedMeal} deleteSavedMeal={deleteSavedMeal} /> : null}
