...
export default function App() {
  ...
  return <SafeAreaView style={styles.safe}><StatusBar style="dark" /><ScrollView style={styles.scrollArea} contentContainerStyle={styles.content}>
    ...
    {screen === "profile" ? <ProfileScreen profile={profile} setProfile={setProfile} targets={targets} /> : null}
...
function ProfileScreen({ profile, setProfile, targets }: { profile: UserProfile; setProfile: Dispatch<SetStateAction<UserProfile>>; targets: ReturnType<typeof calculateTargets> }) {
