...
export default function App() {
  ...
  async function saveNutritionProfile() {
    if (!supabase || !session) return Alert.alert("Perfil", "Entre na conta para salvar no Supabase.");
    setSyncing(true);
    try {
      await ensureProfile();
  ...
  return <SafeAreaView style={styles.safe}><StatusBar style="dark" /><ScrollView style={styles.scrollArea} contentContainerStyle={styles.content}>
    ...
    {screen === "profile" ? <ProfileScreen profile={profile} setProfile={setProfile} targets={targets} saveNutritionProfile={saveNutritionProfile} /> : null}
...
function ProfileScreen({ profile, setProfile, targets, saveNutritionProfile }: { profile: UserProfile; setProfile: Dispatch<SetStateAction<UserProfile>>; targets: ReturnType<typeof calculateTargets>; saveNutritionProfile: () => void }) {
