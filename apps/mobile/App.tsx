...
export default function App() {
  ...
  return <SafeAreaView style={styles.safe}><StatusBar style="dark" /><ScrollView style={styles.scrollArea} contentContainerStyle={styles.content}>
    ...
    {screen === "scanner" ? <ScannerScreen scannerPermission={scannerPermission} scanLocked={scanLocked} openScanner={openScanner} handleBarcode={handleBarcode} setScreen={setScreen} /> : null}
