...
export default function App() {
  ...
  return <SafeAreaView style={styles.safe}><StatusBar style="dark" /><ScrollView style={styles.scrollArea} contentContainerStyle={styles.content}>
    ...
    {screen === "profile" ? <ProfileScreen profile={profile} setProfile={setProfile} targets={targets} saveNutritionProfile={saveNutritionProfile} profileSaveMessage={profileSaveMessage} syncing={syncing} isSystemAdmin={isSystemAdmin} /> : null}
    {screen === "plans" ? <PlansScreen isSystemAdmin={isSystemAdmin} /> : null}
...
function PlansScreen({ compact = false, isSystemAdmin = false }: { compact?: boolean; isSystemAdmin?: boolean }) {
