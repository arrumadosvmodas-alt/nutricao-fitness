...
export default function App() {
  ...
  return <SafeAreaView style={styles.safe}><StatusBar style="dark" /><ScrollView style={styles.scrollArea} contentContainerStyle={styles.content}>
    ...
    {screen === "today" ? <TodayScreen totals={totals} remaining={remaining} waterTotal={waterTotal} exerciseTotal={exerciseTotal} latestWeight={latestWeight} entries={dayFoods} activeFast={activeFast} setScreen={setScreen} openScanner={openScanner} removeFood={removeFood} startEditFood={startEditFood} /> : null}
